...
import { AddAssetsInPortfolio } from '../api/PortfolioAssets';
import "./SearchTicker.css"

export default function AvailableAssetsSearchPortfolio({ onClose, onRefresh, portfolio_name, quantity }) {

 async function handleAdd(ticker) {
    if (!ticker.trim()) return;
    await AddAssetsInPortfolio(portfolio_name, ticker, quantity );
    onRefresh(); 
    onClose();
  } 
